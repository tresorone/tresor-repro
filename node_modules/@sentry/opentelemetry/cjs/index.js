...
function getContext(scope, forceTransaction) {
  ...
  const ctxWithSpanContext = api.trace.setSpanContext(ctxWithoutSpan, spanContext);
...
class SentrySampler  {
  ...
  /** @inheritDoc */
   shouldSample(
    ...
    let traceState = _optionalChain([parentContext, 'optionalAccess', _3 => _3.traceState]) || new core$1.TraceState();
    ...
    if (!mutableSamplingDecision.decision) {
      return { decision: sdkTraceBase.SamplingDecision.NOT_RECORD, traceState: traceState };
    }
